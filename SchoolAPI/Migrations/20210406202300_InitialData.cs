        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignmentName = table.Column<string>(maxLength: 60, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionName = table.Column<string>(maxLength: 60, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "CourseId", "AssignmentId", "CourseName", "SectionId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("80abbca8-664d-4b20-b5de-024705497d4a"), null, new Guid("c9d4c053-49b6-410c-bc78-2d54a9991870"), "kwilliams" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CourseId", "OrganizationId", "UserName" },
                values: new object[] { new Guid("86dba8c0-d178-41e7-938c-ed49778fb52a"), null, new Guid("c9d4c053-49b6-410c-bc78-2d54a9991870"), "ka393939" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CourseId", "OrganizationId", "UserName" },
                values: new object[] { new Guid("021ca3c1-0deb-4afd-ae94-2159a8479811"), null, new Guid("3d490a70-94ce-4d15-9494-5248280c2ce3"), "kaw3939" });
